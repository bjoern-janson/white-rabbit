# G7 Q3 Replication Assay v0.1.1 — Provenance Repair

Version: `G7_Q3_REPLICATION_ASSAY_V0.1.1`

Status: `CONSTITUTED / NOT_EXECUTED / REVIEW_REQUIRED / NON_AUTHORIZING`

Parent constitution:

`assays/G7_Q3_REPLICATION_ASSAY_V0_1.md`

Parent blob:

`038f3e62e4065f5f3bd0df92136f95f2e2c17670`
...
All frozen Q3 treatment/control bytes, hashes, target bytes/hash, request construction, runtime,
...
Q2_EVIDENTIAL_AUTHORITY_FOR_Q3: NONE
Q2_OBSERVATIONS_ENTERING_Q3: 0
```

The historical Q2 assertion may be retained only as unresolved motivational context.

It must not be represented as repository-verified evidence, used to authorize Q3, or used to
interpret a future Q3 result.
...
That burden remains frozen as an **independent prospective Q3 design choice**.

Any parent wording that justifies the burden by saying it “matches the fresh Q2 replication burden”
is superseded. The Q3 sample size does not depend on a repository-resolvable Q2 result.
...
and confirm that no Q2 source object or Q2 outcome is required for Q3 execution or interpretation.
...
For the effective Q3 constitution:
...
```text
artifact: G7_Q3_REPLICATION_ASSAY_V0.1.1
status: CONSTITUTED / NOT_EXECUTED / REVIEW_REQUIRED / NON_AUTHORIZING
